...
/*
 * Purpose : For Lee County Search API's
 * Package : Controller
...
let leeController = {validate,tax}
  ...
  async function tax(req, res) {
     ...
     if (!errors.isEmpty()) {
      ...
      try {
        ...
        await page.goto(`https://lee.county-taxes.com/public/search/property_tax?search_query=${req.query.ParcelID}`, { waitUntil: 'networkidle0', timeout: 0 });
        ...
        let Response = {};
            ...
            Response.BillPdfLink = (BillPdfLink) ? (`https://lee.county-taxes.com${BillPdfLink}`) : "";
        await browser.close();
